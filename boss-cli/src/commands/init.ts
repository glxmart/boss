...
export async function initCommand(options: BootstrapOptions): Promise<void> {
  logger.section('🤖 BOSS Init');
  ...
  try {
    ...
    logger.success(`Project "${config.name}" has been initialized successfully!`);
    logger.info(`\nNext steps:`);
