# Template Documentation: T3 Stack (Prisma)

This project was bootstrapped using the **T3 Stack (Prisma)** template via `create-t3-app`, which provides a full-stack TypeScript application with best practices.
